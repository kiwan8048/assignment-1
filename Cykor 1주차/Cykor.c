...
void push_func1(int arg1, int arg2, int arg3, int var_1)
{
        SP++;
        call_stack[SP] = arg1;
        strcpy(stack_info[SP], "첫번째 매개변수");
        SP++;
        call_stack[SP] = arg2;
        strcpy(stack_info[SP], "두번째 매개변수");
        SP++;
        call_stack[SP] = arg3;
        strcpy(stack_info[SP], "세번째 매개변수");
        SP++;
        call_stack[SP] = -1;
        strcpy(stack_info[SP], "Return Address");
        SP++;
        call_stack[SP] = -1;
        strcpy(stack_info[SP], "main함수의 SFP");
        FP = SP;
        SP++;
        call_stack[SP] = var_1;
        strcpy(stack_info[SP], "첫번째 지역변수");
}
...
void push_func3(int arg1, int var_3, int var_4)
{
    ...
    strcpy(stack_info[SP - 1], "첫번째 지역변수");
    call_stack[SP] = var_4;
    strcpy(stack_info[SP], "두번째 지역변수");
}
